...
void setup() {
  ...
  myDFPlayer.volume(currentVolume);         // Lautstärke (0 bis 30)
...
void printKategorie() {
  if (spielKategorie == 1) {
    ...
    else if (spielKategorie == 3) {
    Serial.println("Musik und ihre Instrumente");
  }
    else if (spielKategorie == 4) {
    Serial.println("Mathematik");
  }
    else if (spielKategorie == 5) {
    Serial.println("Tiere Englisch");
  }
    else if (spielKategorie == 6) {
    Serial.println("Tiere Portugiesisch");
  }
    else {
      Serial.println("Kategorie Fehler");
    }
}
/*
  if (uid == "B31ABB16") {
